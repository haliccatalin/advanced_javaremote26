...
public class Main {
    public static void main(String[] args) {
        ...
        JavaDeveloper javaDeveloper = new JavaDeveloper(3, "Junior");
        javaDeveloper.printExperienceAndLevel();

        javaDeveloper.setInfo("Popescu", "popescu@gmail.com", "0758465218");

        javaDeveloper.printDeveloperDetails();
    }
}
